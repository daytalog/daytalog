...
export const FieldArray = ({ scope, type }: FieldArrayProps) => {
  ...
  return (
    <dd className="mt-1 text-sm leading-6 text-gray-400 flex flex-col gap-3">
                    ...
                    <FormItem className="w-full">
                      <FormControl>
                        <Input
                          ...
                          type="text"
                          {...field}
                          className="block w-full bg-zinc-950 py-1.5 hover:text-white focus:text-white placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-0 focus-visible:shadow-none sm:text-sm sm:leading-6"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
      ...
      <div className={`${fields.length && 'absolute right-0 -top-1'}`}>
